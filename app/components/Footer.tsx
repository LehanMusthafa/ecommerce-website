export default function Footer() {
  return (
    <footer className="bg-white">
      <div className="mx-auto w-full max-w-7xl items-center justify-between p-6 lg:px-8 py-6 lg:py-12">
        ...
        <hr className="my-6 border-gray-200 sm:mx-auto lg:my-16" />
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="font-semibold tracking-tight text-lg text-primary">
            DREAMBLISS
          </span>
          <div className="flex mt-4 sm:justify-center gap-x-6 sm:mt-0">
            <a
              href="#"
